...
class DailyAskPage extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return  _DailyAskPage();
  }

}
class _DailyAskPage extends State<DailyAskPage>{
  AskAnsEntity entity=null;
  int page=0;
  ...
  _getDailyAsk(int page)async{
    ...
    String url="https://wanandroid.com/wenda/list/$page/json ";

    var respon=await NetUtil.get(url);

    if(page==0){
      entity=AskAnsEntity().fromJson(respon);
    }else{
      entity.data.datas.addAll(AskAnsEntity().fromJson(respon).data.datas);
    }
