...
interviewaboutEntityFromJson(InterviewaboutEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new InterviewaboutData().fromJson(json['data']);
	}
...
Map<String, dynamic> interviewaboutEntityToJson(InterviewaboutEntity entity) {
...
interviewaboutDataFromJson(InterviewaboutData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<InterviewaboutDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new InterviewaboutDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> interviewaboutDataToJson(InterviewaboutData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
interviewaboutDataDataFromJson(InterviewaboutDataData data, Map<String, dynamic> json) {
...
Map<String, dynamic> interviewaboutDataDataToJson(InterviewaboutDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
