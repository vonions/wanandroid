...
collectionListEntityFromJson(CollectionListEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new CollectionListData().fromJson(json['data']);
	}
...
collectionListDataFromJson(CollectionListData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<CollectionListDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new CollectionListDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> collectionListDataToJson(CollectionListData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
collectionListDataDataFromJson(CollectionListDataData data, Map<String, dynamic> json) {
	if (json['author'] != null) {
...
Map<String, dynamic> collectionListDataDataToJson(CollectionListDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
