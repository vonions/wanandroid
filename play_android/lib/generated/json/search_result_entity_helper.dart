...
searchResultDataFromJson(SearchResultData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = new List<SearchResultDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new SearchResultDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
searchResultDataDataFromJson(SearchResultDataData data, Map<String, dynamic> json) {
...
Map<String, dynamic> searchResultDataDataToJson(SearchResultDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
