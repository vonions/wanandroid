...
loginResultEntityFromJson(LoginResultEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new LoginResultData().fromJson(json['data']);
	}
...
loginResultDataFromJson(LoginResultData data, Map<String, dynamic> json) {
	if (json['admin'] != null) {
...
Map<String, dynamic> loginResultDataToJson(LoginResultData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
