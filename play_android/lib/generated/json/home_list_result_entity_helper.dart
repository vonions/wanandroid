...
homeListResultEntityFromJson(HomeListResultEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new HomeListResultData().fromJson(json['data']);
	}
...
Map<String, dynamic> homeListResultEntityToJson(HomeListResultEntity entity) {
...
homeListResultDataFromJson(HomeListResultData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<HomeListResultDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new HomeListResultDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> homeListResultDataToJson(HomeListResultData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
homeListResultDataDataFromJson(HomeListResultDataData data, Map<String, dynamic> json) {
...
Map<String, dynamic> homeListResultDataDataToJson(HomeListResultDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
