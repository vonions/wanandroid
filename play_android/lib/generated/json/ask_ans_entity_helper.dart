...
askAnsEntityFromJson(AskAnsEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new AskAnsData().fromJson(json['data']);
	}
...
Map<String, dynamic> askAnsEntityToJson(AskAnsEntity entity) {
...
askAnsDataFromJson(AskAnsData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<AskAnsDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new AskAnsDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> askAnsDataToJson(AskAnsData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
askAnsDataDataFromJson(AskAnsDataData data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = new List<AskAnsDataDatasTag>();
		(json['tags'] as List).forEach((v) {
			data.tags.add(new AskAnsDataDatasTag().fromJson(v));
		});
	}
	if (json['title'] != null) {
...
Map<String, dynamic> askAnsDataDataToJson(AskAnsDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
askAnsDataDatasTagFromJson(AskAnsDataDatasTag data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> askAnsDataDatasTagToJson(AskAnsDataDatasTag entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
